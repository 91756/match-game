...
class MatchGame extends Component {
    ...
    return (
      <div className="score-container">
        <img
          ...
          alt="trophy"
        />
        <p className="txt-name">YOUR SCORE</p>
  ...
  renderITemList = () => {
    ...
    const {isTrue, score, timer, imgUrl, activeTabId} = this.state
    return (
      <div className="items-list-cont">
        <div className="image-cont">
          <img src={imgUrl} className="imgUrl" alt="match" />
        </div>
        ...
        <ul className="img-list-cont">
          {filteredProjects.map(eachImgList => (
            <ImageItem
              imageDetails={eachImgList}
              key={eachImgList.id}
    ...
    return (
      <div className="app-container">
        ...
        <div className="image-container">
          {isTrue ? this.renderScore() : this.renderITemList()}
        </div>
      </div>
    )
  }
